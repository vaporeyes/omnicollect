...
function buildLightTokens(colors: string[]) {
  ...
  return {
    ...
    '--bg-secondary': hsl(bg.h, bg.s, bg.l - 2),
    '--bg-tertiary': hsl(bg.h, bg.s + 2, bg.l - 6),
    ...
    '--border-primary': hsl(bg.h, bg.s + 5, bg.l - 12),
...
function buildDarkTokens(colors: string[]) {
  ...
  return {
    ...
    '--bg-secondary': hsl(bg.h, bg.s - 3, bg.l + 5),
    '--bg-tertiary': hsl(bg.h, bg.s - 5, bg.l + 12),
    ...
    '--text-on-accent': hsl(bg.h, 5, 99),
    '--border-primary': hsl(bg.h, bg.s - 5, bg.l + 16),
